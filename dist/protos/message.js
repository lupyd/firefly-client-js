...
function createBaseRequest() {
    return { id: 0, createUserMessage: undefined, uploadUserMessage: undefined };
}
exports.Request = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.id !== 0) {
...
function createBaseResponse() {
    return { id: 0, error: undefined, createdUserMessage: undefined, userMessageUploaded: undefined };
}
exports.Response = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.id !== 0) {
