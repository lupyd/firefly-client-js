...
function createBaseEncryptedFile() {
    return { url: "", contentType: 0, secretKey: new Uint8Array(0), secretKeyType: 0 };
}
exports.EncryptedFile = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.secretKeyType !== 0) {
            writer.uint32(32).uint32(message.secretKeyType);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.secretKeyType = reader.uint32();
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            secretKeyType: isSet(object.secretKeyType) ? globalThis.Number(object.secretKeyType) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.secretKeyType !== 0) {
            obj.secretKeyType = Math.round(message.secretKeyType);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.secretKeyType = object.secretKeyType ?? 0;
        return message;
    },
};
